...
export class PerformanceResultUtilsService {
  ...
  constructor() {
    this.children['0'] = {
      color: this.veryLowColor,
      description: this.veryLowText,
    };
    this.children['1'] = {
      color: this.belowColor,
      description: this.belowText,
    };
    this.children['IDEAL'] = {
      color: this.expectedColor,
      description: this.expectedText,
    };
    ...
    this.thirdYear['IDEAL'] = {
      color: this.expectedColor,
      description: this.expectedText,
    };
  }

  getStudentPerformanceDefinition(
    schoolGradeYear: number,
    level: string,
  ): StudentPerformanceDefinitionDto {
