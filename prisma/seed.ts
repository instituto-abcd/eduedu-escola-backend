...
async function main() {
  ...
  const awardOneId = uuidv4();
  const awardTwoId = uuidv4();
  const awardThreeId = uuidv4();
  const awardFourId = uuidv4();
    ...
    data: [
      {
        ...
        name: 'motivado',
        title: 'Motivado',
        description: 'Completou 2 avaliações',
      },
      {
        id: awardTwoId,
        name: 'maestro',
        title: 'Maestro',
        description: 'Atingiu nível esperado em consciência fonológica',
      },
      {
        id: awardThreeId,
        name: 'leitor',
        title: 'Leitor',
        description: 'Atingiu nível esperado em leitura e compreensão de texto',
      },
      {
        id: awardFourId,
        name: 'escritor',
        title: 'Escritor',
        description: 'Atingiu nível esperado em sistema de escrita alfabética',
      },
      {
        id: uuidv4(),
        name: 'confiante',
        title: 'Confiante',
        description: 'Acessou a área socioemocional 2 vezes',
      },
      {
        id: uuidv4(),
        name: 'corajoso',
        title: 'Corajoso',
        description: 'Acessou a área socioemocional 5 vezes',
      },
      {
        id: uuidv4(),
        name: 'sensivel',
        title: 'Sensível',
        description: 'Acessou a área socioemocional 10 vezes',
      },
      {
        id: uuidv4(),
        name: 'fantastico',
        title: 'Fantástico',
        description: 'Completou 1 planeta',
      },
      {
        id: uuidv4(),
        name: 'lutador',
        title: 'Lutador',
        description: 'Completou 5 planetas',
      },
      {
        id: uuidv4(),
        name: 'super',
        title: 'Super',
        description: 'Completou 10 planetas',
      },
      {
        id: uuidv4(),
        name: 'incrivel',
        title: 'Incrível',
        description: 'Completou 15 planetas',
      },
      {
        id: uuidv4(),
        name: 'excelente',
        title: 'Excelente',
        description: 'Completou 20 planetas',
      },
      {
        id: uuidv4(),
        name: 'brilhante',
        title: 'Brilhante',
        description: 'Completou 25 planetas',
      },
      {
        id: uuidv4(),
        name: 'gigante',
        title: 'Gigante',
        description: 'Completou 30 planetas',
      },
      {
        id: uuidv4(),
        name: 'competente',
      ...
      },
      {
        ...
        name: 'bombastico',
        title: 'Bombástico',
        description: 'Completou 40 planetas',
      },
      {
        id: uuidv4(),
        name: 'sensacional',
        title: 'Sensacional',
        description: 'Completou 45 planetas',
      },
      {
        id: uuidv4(),
        name: 'perfeito',
        title: 'Perfeito',
        description: 'Completou 50 planetas',
      },
    ],
  });
  ...
  if (env === 'development') {
    ...
    const dashboardSchoolGradeId = uuidv4();
